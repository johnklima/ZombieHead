...
public class AlexanderIdle : AnimationScript // In case the 'actual' drag animation doesn't count.
{
    ...
    void Start()
    {
        ...
        positionArrayRight[0] = new Vector3(0.0f, 0.0f, 0.0f);
        positionArrayRight[1] = new Vector3(1.0f, 0.0f, 5.0f);
        positionArrayRight[2] = new Vector3(0.2f, 0.3f, 1.4f);
        positionArrayRight[3] = new Vector3(0.5f, 1.5f, 0.5f);
        positionArrayLeft[0] = new Vector3(0.0f, 0.0f, 0.0f);
        positionArrayLeft[1] = new Vector3(1.0f, 0.0f, 5.0f);
        positionArrayLeft[2] = new Vector3(0.2f, 0.3f, 1.4f);
        positionArrayLeft[3] = new Vector3(0.5f, 1.5f, 0.5f);
